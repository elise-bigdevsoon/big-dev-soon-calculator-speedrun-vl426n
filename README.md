...
3. Go through the design images on the [project's page](https://app.bigdevsoon.me/projects/calculator) and import the `.fig` file into Figma to understand the layout and design elements.k
